          ...
          <div class="max-w-xl space-y-6">
            ...
            <article class="relative">
              <div class="relative grid h-[340px] content-end gap-4">
                <div class="max-w-xs rounded-[28px] border-2 border-[#1f4f46] bg-[#dff3ea] p-5 shadow-[8px_8px_0_0_rgba(31,79,70,0.12)]">
                ...
                <div class="grid gap-3 sm:grid-cols-2">
                  <div class="rounded-3xl border-2 border-[#d9982c] bg-[#ffecc4] p-4 shadow-[6px_6px_0_0_rgba(217,152,44,0.12)]">
                    <p class="text-[11px] font-semibold uppercase tracking-[0.26em] text-[#8c4d29]">Starter</p>
                    <p class="mt-2 text-lg font-semibold text-slate-900">3 inmuebles</p>
                  </div>
                  <div class="rounded-3xl border-2 border-[#c96a37] bg-[#fff1e7] p-4 shadow-[6px_6px_0_0_rgba(201,106,55,0.12)]">
                    <p class="text-[11px] font-semibold uppercase tracking-[0.26em] text-[#8c4d29]">Cobros</p>
                    <p class="mt-2 text-lg font-semibold text-slate-900">Seguimiento manual</p>
                  </div>
                </div>
              </div>
            </article>
