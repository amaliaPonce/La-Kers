<template>
  <span
    class="inline-flex items-center whitespace-nowrap rounded-full font-semibold"
    :class="[compact ? 'gap-1.5 px-2.5 py-0.5 text-[10px]' : 'gap-2 px-3 py-1 text-[11px]', badgeClass]"
  >
