...
create index if not exists tenant_contract_profiles_company_name_idx on public.tenant_contract_profiles(company_name);
create index if not exists tenant_contract_profiles_tax_id_idx on public.tenant_contract_profiles(tax_id);
...
create unique index if not exists notification_events_dedupe_key_idx on public.notification_events(dedupe_key);
create index if not exists notification_events_payment_id_idx on public.notification_events(payment_id);
create index if not exists notification_events_owner_id_idx on public.notification_events(owner_id);
create index if not exists notification_events_tenant_person_id_idx on public.notification_events(tenant_person_id);
